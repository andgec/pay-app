...
class ExtendedAddressMixin(models.Model):
    '''
    Mixin class that adds additional contact fields and methods
    '''
    #mobile_phone_no = models.CharField(max_length=20, blank=True, default='')
    fax_no          = models.CharField(max_length=20, blank=True, default='')
